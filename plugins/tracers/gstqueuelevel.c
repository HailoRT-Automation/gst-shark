...
static void do_queue_level(GstTracer *tracer, guint64 ts, GstPad *pad, GstBuffer *buffer);
...
static void
do_queue_level(GstTracer *self, guint64 ts, GstPad *pad, GstBuffer *buffer)
{
  GstElement *element;
  guint32 size_bytes;
                    ...
                    GstBufferList *list)
{
  ...
  {
    do_queue_level(tracer, ts, pad, &buf);
  }
}
...
gst_queue_level_tracer_class_init(GstQueueLevelTracerClass *klass)
{
  ...
  tr_qlevel = gst_tracer_record_new("queuelevel.class", "queue",
                                    GST_TYPE_STRUCTURE, gst_structure_new("scope", "type", G_TYPE_GTYPE, G_TYPE_STRING, "related-to", GST_TYPE_TRACER_VALUE_SCOPE, GST_TRACER_VALUE_SCOPE_ELEMENT, NULL), "size_bytes",
                                    GST_TYPE_STRUCTURE, gst_structure_new("scope", "type", G_TYPE_GTYPE, G_TYPE_UINT, "related-to", GST_TYPE_TRACER_VALUE_SCOPE, GST_TRACER_VALUE_SCOPE_ELEMENT, NULL), "max_size_bytes",
                                    GST_TYPE_STRUCTURE, gst_structure_new("scope", "type", G_TYPE_GTYPE, G_TYPE_UINT, "related-to", GST_TYPE_TRACER_VALUE_SCOPE, GST_TRACER_VALUE_SCOPE_ELEMENT, NULL), "size_buffers",
                                    GST_TYPE_STRUCTURE, gst_structure_new("scope", "type", G_TYPE_GTYPE, G_TYPE_UINT, "related-to", GST_TYPE_TRACER_VALUE_SCOPE, GST_TRACER_VALUE_SCOPE_ELEMENT, NULL), "max_size_buffers",
                                    GST_TYPE_STRUCTURE, gst_structure_new("scope", "type", G_TYPE_GTYPE, G_TYPE_UINT, "related-to", GST_TYPE_TRACER_VALUE_SCOPE, GST_TRACER_VALUE_SCOPE_ELEMENT, NULL), "size_time",
                                    GST_TYPE_STRUCTURE, gst_structure_new("scope", "type", G_TYPE_GTYPE, G_TYPE_STRING, "related-to", GST_TYPE_TRACER_VALUE_SCOPE, GST_TRACER_VALUE_SCOPE_ELEMENT, NULL), "max_size_time",
                                    GST_TYPE_STRUCTURE, gst_structure_new("scope", "type", G_TYPE_GTYPE, G_TYPE_STRING, "related-to", GST_TYPE_TRACER_VALUE_SCOPE, GST_TRACER_VALUE_SCOPE_ELEMENT, NULL), NULL);
