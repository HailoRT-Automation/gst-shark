...
void do_print_cpuusage_event(event_id id, guint32 cpu_num, gfloat *cpuload)
{
  GError *error;
  guint8 *mem;
  guint8 *event_mem;
...
void do_print_threadmonitor_event(event_id id, guint32 cpu_num, gfloat *cpuload)
{
  GError *error;
  guint8 *mem;
  guint8 *event_mem;
...
void do_print_queue_level_event(event_id id, const gchar *elementname,
